...
##############################
# Main application
gc_cmd1="mogobot"	# Name
gc_typeMogo1="mpi"	# RegEx to get the good game
gc_nbThreads1="4"	# Threads per machine
gc_nbMachines1="2" 	# Machines needed
...
mydate=$(date +%F-%Hh%M)
nom_fich_res="resultsTournamentBull_$gc_cmd1.VS.$gc_cmd2_$mydate"
##############################
# One/ Go Application
##############################
###
